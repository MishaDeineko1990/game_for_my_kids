...
/** A deliberately beatable "vs computer" opponent: moves toward the ball's x with no
 *  anticipation, and only jumps once the ball is close and coming down within reach --
 *  a 3-5..8 year old should be able to consistently win points against it. */
object SimpleAi {
    ...
    fun decide(blob: BlobState, ball: BallState): BlobInput {
        ...
        return BlobInput(moveDirection = moveDirection, jump = jump)
    }
}
